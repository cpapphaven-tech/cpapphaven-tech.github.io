...
const I18N = {
    ...
    "hi": { flag:"🇮🇳 HI", dir:"ltr", read:"और पढ़ें <span>↗</span>", source:"स्रोत: ", no_news:"कोई समाचार उपलब्ध नहीं।", swipe:"ऊपर स्वाइप करें", legal:"कानूनी अस्वीकरण", legal_text_1:"सभी लेख उनके प्रकाशकों के हैं। Playmix RSS फ़ीड के माध्यम से समाचार एकत्र करता है।", legal_text_2:"DMCA अनुरोध के लिए संपर्क करें:", back_top:"शीर्ष पर वापस ↑", time_under1h:"1 घंटे से कम", time_xhago:(h)=>`${h} घंटे पहले`, cats:{ local:"📍 स्थानीय", top:"🌐 टॉप", finance:"📈 वित्त", sports:"⚽ खेल", entertainment:"🎬 मनोरंजन", technology:"💻 तकनीक", health:"⚕️ स्वास्थ्य", gaming:"🎮 गेमिंग", science:"🔬 विज्ञान" } },
...
function handleHorizontalSwipe(duration) {
    ...
    const categories = ['local','top','finance','sports','entertainment','technology','health','gaming','science'];
