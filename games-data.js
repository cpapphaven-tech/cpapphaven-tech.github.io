  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Gem Match",        genre: "Match-3",  icon: "",                                 href: "GemMatch/index.html",            badge: "new",  emoji: "💎" },
        { name: "Candy Blast",      genre: "Match-3",  icon: "",                                 href: "CandyBlast/index.html",          badge: "new",  emoji: "🍬" },
        { name: "Pet Pop",          genre: "Match-3",  icon: "",                                 href: "PetPop/index.html",              badge: "new",  emoji: "🐶" },
        { name: "Veggie Smash",     genre: "Match-3",  icon: "",                                 href: "VeggieSmash/index.html",         badge: "new",  emoji: "🥕" },
