(function () {
    ...
    const games = [
        ...
        { name: "🧬 Helix Bounce Drop", path: "HelixBounce/index.html", icon: "img/helix200.png", tip: "Arcade" },
        { name: "🎈 Math Balloon Pop", path: "NumberBalloonShooter/index.html", icon: "assets/numberballoon200.png", tip: "Action" },
        { name: "🧱 Brick Breaker Retro", path: "BrickBreaker/game.html", icon: "img/brickbreaker200.png", tip: "Classic" },
        { name: "🎾 Tennis Master 3D", path: "Tennis/game.html", icon: "assets/Tennis200.png", tip: "Sports" },
        { name: "🎳 Bowling Strike 3D", path: "Bowling/game.html", icon: "assets/Bowling200.png", tip: "Sports" },
        { name: "🧪 Water Sort Puzzle", path: "WaterSort3D/index.html", icon: "assets/watersort3d.png", tip: "Puzzle" },
        { name: "🍾 Bottle Shoot Sniper", path: "BottleShoot3D/index.html", icon: "img/bottle200.png", tip: "Sports" },
        { name: "⚽ Head Football 1v1", path: "HeadFootball/index.html", icon: "assets/head_football_icon.png", tip: "Sports" },
        { name: "⛳ Mini Golf Pocket", path: "PocketGolf/index.html", icon: "assets/pocket_golf_icon.png", tip: "Sports" },
        { name: "🏏 Cricket T20 Master", path: "CricketMaster/index.html", icon: "assets/cricket_master_icon.png", tip: "Sports" },
        { name: "🏑 Neon Air Hockey 3D", path: "AirHockey3D/index.html", icon: "img/airhockey200.png", tip: "Sports" },
        { name: "🔢 Classic Sudoku Daily", path: "Sudoku/index.html", icon: "img/sudoku200.png", tip: "Logic" },
        { name: "🏀 Basketball 3D Hoops", path: "Basketball3D/index.html", icon: "assets/basketball3d.png", tip: "Sports" },
        { name: "🎲 Ludo Classic Board", path: "Ludo/index.html", icon: "img/ludo200.png", tip: "Board" },
        { name: "🔵 Bubble Shooter Pop", path: "BubbleShooter/index.html", icon: "assets/bubble_shooter.png", tip: "Arcade" },
        { name: "♟ Chess Master Online", path: "Chess/index.html", icon: "assets/chess100.png", tip: "Board" },
        { name: "⚔️ Stickman Warriors", path: "StickDuel/index.html", icon: "assets/stckduels.png", tip: "Action" },
        { name: "🏓 Ping Pong 3D", path: "TableTennis/index.html", icon: "assets/tabletennis320.png", tip: "Sports" },
        { name: "🎨 Color Match Reaction", path: "ColorMatch/index.html", icon: "assets/colormatch.png", tip: "Reaction" },
